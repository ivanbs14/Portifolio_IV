...
export const projectsData = [
   ...
   {
     imgLogo: imgMemory,
     titleCd: "Jogo da memória",
     subTitleCd: "Um jogo da memória é um desafio mental onde os jogadores revelam cartas emparelhadas, tentando lembrar suas posições. O objetivo é encontrar todos os pares correspondentes, melhorando a memória e a concentração.",
     btnRefGit: "https://github.com/ivanbs14/App_memory.git",
     //btnRef: "https://foofexploreriv.netlify.app/",
     icons: { nd: true, js: true, sc: true, rc: true,ts: true },
     video: 'https://youtu.be/Svwc3Kv0QYE',
   },
   {
     imgLogo: imgMovie,
   ...
   },
   {
     ...
     video: 'https://youtu.be/LFhiYoKkfRk',
   },
   {
     imgLogo: imgNotpad,
     titleCd: "Notpad",
